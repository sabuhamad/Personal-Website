...
const useStyles = makeStyles({
    ...
    cardContainer: {
        ...
        transition: 'all 0.3s ease-in-out',  // Add this for a smooth transition on hover
        borderRadius: '12px',
        overflow: 'hidden',
        '&:hover': {
            transform: 'translateY(-8px)',  // Lift the card on hover
            boxShadow: "0 12px 30px rgba(0, 0, 0, 0.15)",  // Increase the box shadow on hover
        }
    },
    customButton: {
        background: '#FF6B35', // Set your desired background color
        borderColor: '#FF6B35', // Set your desired border color
        ...
        '&:hover': {
          background: '#E55A2B', // Set your desired hover background color
          borderColor: '#E55A2B', // Set your desired hover border color
